...
<main class="rbc68-content">
	<?php while ( have_posts() ) : the_post(); ?>
		...
		$map_link = rbc68_event_directions_url( $event_id );
		?>
		<article <?php post_class( 'rbc68-article rbc68-event-page' ); ?>>
			...
			<?php if ( $map_link ) : ?><p><strong>Lieu :</strong> <a href="<?php echo esc_url( $map_link ); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr( 'Ouvrir l’itinéraire vers ' . ( $location ?: 'le lieu de l’événement' ) . ' (nouvel onglet)' ); ?>"><?php echo esc_html( $location ?: 'Ouvrir l’itinéraire' ); ?></a></p><?php endif; ?>
