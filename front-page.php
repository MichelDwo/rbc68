...
<!-- Introduction compacte -->
  ...
  <section id="essentiel" class="essentials" aria-labelledby="essentiel-title">
    ...
    <div class="essentials-grid">
      <article class="essential-card essential-location">
        ...
        <div>
          ...
          <div class="essential-mini-map">
            <a href="<?php echo esc_url( rbc68_mod( 'rbc68_map_link', 'https://www.google.com/maps/dir/?api=1&destination=47.7331928%2C7.3777678' ) ); ?>" target="_blank" rel="noopener noreferrer" aria-label="Ouvrir l’itinéraire vers la salle du RBC68 (nouvel onglet)">
              <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/salle-map.webp' ); ?>" width="800" height="400" alt="Localisation de la salle du RBC68 à Rixheim" loading="lazy" decoding="async">
            </a>
          </div>
          <p class="essential-map-credit">© <a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener noreferrer">OpenStreetMap contributors</a></p>
      ...
      <article class="essential-card">
        <span class="essential-icon" aria-hidden="true">€</span>
        <div><h3>Combien ?</h3><dl class="essential-prices"><div><dt>Mini-bad</dt><dd><?php echo esc_html( rbc68_join_price( 'mini' ) ); ?></dd></div><div><dt>Jeunes</dt><dd><?php echo esc_html( rbc68_join_price( 'youth' ) ); ?></dd></div><div><dt>Adultes</dt><dd><?php echo esc_html( rbc68_join_price( 'adults' ) ); ?></dd></div></dl><a href="#inscription">Tarifs et documents</a></div>
      </article>
      <article class="essential-card essential-card-accent">
        <span class="essential-icon" aria-hidden="true">✓</span>
        <div><h3>Envie de jouer ?</h3><p><?php echo esc_html( rbc68_join_settings()['summary'] ); ?></p><a href="#inscription">Nous rejoindre</a></div>
      </article>
    </div>
  </section>
